...
//  Vue.component()引用方法
mrsongCountdown.install = Vue => Vue.component(mrsongCountdown.name, mrsongCountdown);//注册组件

// Vue.use()引用方法
// 标签的方式引入，留到后面再另开新篇讨论
//const install = function(Vue, opts = {}) { 
//　　Vue.component(mrsongCountdown.name, mrsongCountdown);
//}
...
export default mrsongCountdown;